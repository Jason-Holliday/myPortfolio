document.addEventListener("DOMContentLoaded", function () {
    ...
    uploadBtn.addEventListener("click", async (event) => {
        ...
        try {
            ...
            const response = await fetch("https://myportfolio-production-f41c.up.railway.app/upload", {
                method: "POST",
                body: formData,
            });
    ...
    document.getElementById("add-project-form").addEventListener("submit", async function (event) {
        ...
        try {
            const response = await fetch("https://myportfolio-production-f41c.up.railway.app/save-project", {
                method: "POST",
    ...
    async function searchProject() {
        ...
        try {
            const response = await fetch(`https://myportfolio-production-f41c.up.railway.app/projects?search=${encodeURIComponent(searchTerm)}`, {
                method: "GET",
                headers: {
    ...
    async function updateProject(projectId) {
        ...
        try {
            const response = await fetch(`https://myportfolio-production-f41c.up.railway.app/projects/${projectId}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                },
